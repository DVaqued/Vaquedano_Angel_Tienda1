...
public class Proyecto1LIMPIO {
    ...
    public static void main(String[] args) {
        ...
        double rankTotalAzucar = 0, rankTotalAvena = 0, rankTotalTrigo = 0, rankTotalMaiz = 0;
        double sumaRankAzucar = 0, sumaRankAvena = 0, sumaRankTotalTrigo, sumaRankTotalMaiz = 0;
                ...
                while (cajaConfirmacion == 1) {
                    ...
                    if (opcion == 2) {
                        if (azucarinv > 0 || trigoinv > 0 || avenainv > 0 || maizinv > 0) {
                            ...
                            System.out.println("-------------------------------------------------------------"
                                    ...
                                    + "\n|1. Azucar: 30 Lps.| 1. Azucar: 30 Lps. | 3. Trigo: 32 Lps. |"
                                    + "\n        " + azucarinv + "                      " + azucarinv + "                 " + trigoinv
                    ...
                    if (opcion == 5) {
                        if (contadorVentas > 0) {
                            ...
                            if (rankTotalMaiz < totalDineroMaiz) {
                                rankTotalMaiz++;
                            }
                            if (rankTotalMaiz < totalDineroAzucar) {
                                rankTotalMaiz++;
                            }
                            if (rankTotalMaiz < totalDineroTrigo) {
                                rankTotalMaiz++;
                            }
                            if (rankTotalAvena < totalDineroMaiz) {
                                rankTotalAvena++;
                            }
                            if (rankTotalAvena < totalDineroAzucar) {
                                rankTotalAvena++;
                            }
                            if (rankTotalAvena < totalDineroTrigo) {
                                rankTotalAvena++;
                            }
                            if (rankTotalAzucar < totalDineroMaiz) {
                                rankTotalAvena++;
                            }
                            if (rankTotalAzucar < totalDineroAvena) {
                                rankTotalAzucar++;
                            }
                            if (rankTotalAzucar < totalDineroTrigo) {
                                rankTotalAzucar++;
                            }
                            if (rankTotalTrigo < totalDineroMaiz) {
                                rankTotalTrigo++;
                            }
                            if (rankTotalTrigo < totalDineroAvena) {
                                rankTotalTrigo++;
                            }
                            if (rankTotalTrigo < totalDineroAzucar) {
                                rankTotalTrigo++;
                            }
                            System.out.println("----------------------Ranking----------------------");
                            System.out.println("Maíz: " + rankTotalMaiz);
                            System.out.println("Avena: " + rankTotalAvena);
                            System.out.println("Azúcar: " + rankTotalAzucar);
